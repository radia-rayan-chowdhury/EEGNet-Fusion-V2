#EEG MODELS: Introducing 5 Branches 
#----------------------------
...
"""
The author of this model will, is and was published along with the paper titled 
...
def EEGNet_fusion_V2(nb_classes, Chans=64, Samples=128,
    ...
    merge_three = concatenate([merge_two, block8])
    merge_four = concatenate([merge_three, block10])

    flatten = Flatten()(merge_four)
...
def get_models(trial_type, nb_classes, samples, use_cpu):
    ...
    return {
        ...
        'EEGNet_fusion_V2': model.Model('EEGNet_fusion_V2', trial_type, [(0, 8), (14, 22), (28, 36),(42,50),(56,64)],
                                     EEGNet_fusion_V2(nb_classes, Samples=samples, cpu=use_cpu), multi_branch=True),
